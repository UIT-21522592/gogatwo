				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="addProduct.php">
              				<i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Add Product</span>
            			</a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="orderHistory.php">
              <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">Orders History</span>
            </a>
					</li>
