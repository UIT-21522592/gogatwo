...
VALUES
  (
    ...
    'Action',
    'action',
    'Fast-paced and intense gameplay. Focus on physical challenges, combat, and reflexes.',
    0,
    1,
    'action.jpg',
    '2023-12-28 11:29:18'
  ...
  (
    ...
    'Adventure ',
    'adventure',
    'Story-driven with a focus on exploration and puzzle-solving.',
    0,
    1,
    'adventure.jpg',
    '2023-12-28 11:30:37'
  ...
  (
    ...
    'Side Dish',
    'side-dish',
    'Perfect side-kicks for perfect main dishes',
    0,
    1,
    '1702819351.jpg',
    '2023-12-17 13:22:31'
  ...
  (
    ...
    'Dessert',
    'dessert',
    'Wide array of delectable sweets and treats',
    0,
    1,
    '1702819929.jpg',
    '2023-12-17 13:32:09'
...
VALUES
  (
    85,
    'hSjs7XnxdostjVx2lN67',
    23,
    'gh',
    'd@e',
    '123',
    ' ,  , Ward An Khanh, District 2',
    380000,
    'COD',
    '',
    0,
...
VALUES
  (
    ...
    'God of War',
    'god-of-war',
    'Epic journey as a legendary warrior.',
    'Embark on an epic journey as a legendary warrior battling mythical creatures.',
    60,
    50,
    'god-of-war.jpg',
    100,
  ...
  (
    ...
    'Marvel\'s Spider-Man',
    'marvels-spider-man',
    'Stealthy assassin in the shadows',
    'Become a stealthy assassin and navigate through the shadows to complete deadly missions.',
    50,
    40,
  ...
  (
    ...
    'Explore a procedurally generated world, battling monsters and unlocking new abilities.',
    40,
    30,
  ...
  (
    ...
    'Horizon Zero Dawn',
    'horizon-zero-dawn',
    'Thrilling adventure to uncover mysteries.',
    'Embark on a thrilling adventure to uncover the mysteries of a lost civilization.',
    65,
    55,
  ...
  (
    ...
    'Ghost of Tsushima',
    'ghost-of-tsushima',
    'Journey through magical realms.',
    'Journey through magical realms and solve puzzles to restore balance to the world.',
    60,
    50,
  ...
  (
    ...
    'Search for hidden treasures in exotic locations, but beware of traps and enemies.',
    50,
    40,
    'days-gone.jpg',
    130,
  ...
  (
    ...
    'Experience the excitement of football with realistic gameplay in FIFA 22.',
    70,
    60,
    'fifa-22.jpg',
    80,
  ...
  (
    ...
    'NBA 2K22',
    'nba-2k22',
    'The premier basketball simulation game.',
    'Play the most realistic basketball game with NBA 2K22.',
    60,
    50,
    'nba-2k22.jpg',
    120,
  ...
  (
    ...
    'Gran Turismo Sport',
    'gran-turismo-sport',
    'A stunning racing experience.',
    'Immerse yourself in the world of realistic racing with Gran Turismo Sport.',
    60,
    50,
...
VALUES
  (
    22,
    'Phạm Nguyệt Quỳnh',
    'phamnguyetquynh0307@gmail.com',
    989598472,
    'default.jpg',
    '394481',
    1,
    '$2y$10$J8tjpZRK.1C7KDU48Knq7OU5R4VkMJRDwWIxavrNJpIwZAZnRRXHq',
    1,
    '2023-12-17 15:25:10'
  ),
  (
    23,
    'Nguyen Mai Huu Phuc',
    'phucnguyenmaihuuuit@gmail.com',
    888135231,
    'default.jpg',
    '621009',
    1,
    '$2y$10$cWYCLPh7q2am96G.96j4cuD2MhCLFiwaPol27utDsqLbAvljAkDF2',
    0,
    '2023-12-25 14:48:49'
  ),
  (
    24,
    'Nguyen Mai Huu Phuc',
    '21522474@gm.uit.edu.vn',
    888135231,
    'default.jpg',
    '486162',
    0,
    '$2y$10$KAI7aa4OO72niu4pAV9NiuhqAF716Cmg1o58SmjLeoWQ3waT0bJ.K',
    0,
    '2023-12-25 16:17:38'
  );
...
ADD
  CONSTRAINT `wishlist_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
